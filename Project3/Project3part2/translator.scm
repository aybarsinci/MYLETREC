  ...
  (define translation-of
    (lambda (exp env)
      (cases expression exp
        ...
        (call-exp (rator rand)
                  (cases expression rator (var-exp (var) (call-nested-exp (translation-of rator env) (translation-of rand env)
                                                                          (diff-exp (var-exp 'count) (diff-exp (const-exp 0) (const-exp 1))) )) ; first is count and second is to get -1
                                                                                                                                                ; so that it is count - - 1 which is => count + 1
                    (else  (call-nested-exp (translation-of rator env) (translation-of rand env) (const-exp 1)) )) )
