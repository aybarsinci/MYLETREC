      ...
      (cases expression exp
        ...
        (let-exp (var exp1 body)
          ...
          ;;implement translation of let-exp here
                 (let ((occurence (+ 1 (apply-senv-number senv var)))
                       (translatedexp (translation-of exp1 senv))
                       (translatedbod (translation-of body (extend-senv var senv)))
                       )
                   (let-exp (string->symbol
                             (string-append (symbol->string var) (number->string occurence)))
                            translatedexp
                            translatedbod ))
